...
export default function Footer() {
  return (
    <footer className="py-8 md:pb-6 md:-mt-[17.50rem] bg-blue-1">
      <div className="max-width pt-[19rem] pb-6 flex flex-col lg:flex-row gap-y-16 items-start justify-between">
